...
class XMLInterior {
    ...
    private void checkHoliday(int noMonth, int currentMonthDay) {
        ...
        else if (1 == noMonth && (1 == currentMonthDay || 6 == currentMonthDay)) holiday.setValue("1"); //New Year & three Kings
        else if (5 == noMonth && (1 == currentMonthDay || 3 == currentMonthDay)) holiday.setValue("1"); //Labour Day & 03.05
        else if (8 == noMonth && 15 == currentMonthDay) holiday.setValue("1"); //Armed Forces Day
        else if (11 == noMonth && (11 == currentMonthDay || 1 == currentMonthDay)) holiday.setValue("1"); //All Saints’ Day & Independence Day
        else if (12 == noMonth && (25 == currentMonthDay || 26 == currentMonthDay)) holiday.setValue("1"); //Christmas
        else if (currentYearDay == dateEaster || currentYearDay == dateEaster + 1) holiday.setValue("1"); //Easter & Monday
